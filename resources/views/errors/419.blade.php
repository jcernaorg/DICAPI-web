...
<head>
    ...
    <title>Error 419 - Expiró la sesión</title>
...
<body class="antialiased error-bg">
    ...
    <div class="min-h-[70vh] flex flex-col items-center justify-center py-16 animate-fade-in animate-delay-400 error-content">
        ...
        <h1 class="text-4xl font-bold mb-4 animate-fade-in animate-delay-600 error-text">419 - Expiró la sesión</h1>
        <p class="text-lg mb-8 text-center animate-fade-in animate-delay-700 error-text">Tu sesión ha expirado por inactividad o por un problema de seguridad.<br>Por favor, recarga la página e inténtalo de nuevo.</p>
