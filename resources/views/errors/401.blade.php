...
<body class="antialiased error-bg">
    ...
    <div class="min-h-[70vh] flex flex-col items-center justify-center py-16 animate-fade-in animate-delay-400 error-content">
        ...
        <h1 class="text-4xl font-bold mb-4 animate-fade-in animate-delay-600 error-text">401 - No autorizado</h1>
        <p class="text-lg mb-8 text-center animate-fade-in animate-delay-700 error-text">No tienes autorización para acceder a este recurso.<br>Por favor, inicia sesión o contacta al administrador.</p>
