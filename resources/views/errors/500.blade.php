...
<body class="antialiased error-bg">
    ...
    <div class="min-h-[70vh] flex flex-col items-center justify-center py-16 animate-fade-in animate-delay-400 error-content">
        ...
        <h1 class="text-4xl font-bold mb-4 animate-fade-in animate-delay-600 error-text">500 - Error interno del servidor</h1>
        <p class="text-lg mb-8 text-center animate-fade-in animate-delay-700 error-text">Ha ocurrido un error inesperado en el servidor.<br>Por favor, intenta nuevamente más tarde o contacta al administrador.</p>
