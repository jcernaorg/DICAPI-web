...
<body class="antialiased error-bg">
    ...
    <div class="min-h-[70vh] flex flex-col items-center justify-center py-16 animate-fade-in animate-delay-400 error-content">
        ...
        <h1 class="text-4xl font-bold mb-4 animate-fade-in animate-delay-600 error-text">429 - Demasiadas peticiones</h1>
        <p class="text-lg mb-8 text-center animate-fade-in animate-delay-700 error-text">Has realizado demasiadas peticiones en poco tiempo.<br>Por favor, espera unos minutos antes de intentarlo de nuevo.</p>
