...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $plantilla->titulo }} - DICAPI</title>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div class="space-y-6 animate-fade-in-left animate-delay-200">
                        ...
                        <div class="space-y-3 text-lg sm:text-xl animate-fade-in animate-delay-400">
                            ...
                            <p><span class="font-semibold">Año:</span> {{ date('Y', strtotime($plantilla->fecha)) }}</p>
                            <p><span class="font-semibold">Código:</span> {{ $plantilla->codigo }}</p>
                        </div>
                        
                        @if($plantilla->archivo)
                        <a href="{{ route('download.plantilla', $plantilla->id) }}" class="inline-block border-2 border-white text-white px-8 sm:px-10 py-4 rounded-none hover:bg-white hover:text-blue-900 transition-colors duration-200 font-semibold hover-lift animate-fade-in animate-delay-500 text-base sm:text-lg">
                            DESCARGAR
                        </a>
                        @else
                    ...
                    <div class="flex items-center justify-center animate-fade-in-right animate-delay-400">
                        @if($plantilla->imagen && file_exists(public_path('storage/plantillas/' . $plantilla->imagen)))
                        <div class="h-96 sm:h-112 lg:h-128 w-full max-w-lg overflow-hidden" style="background-image: url('{{ asset('storage/plantillas/' . $plantilla->imagen) }}'); background-size: cover; background-position: center;">
                        </div>
                        @else
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div class="max-w-4xl mx-auto mb-12 animate-fade-in animate-delay-600">
                    <p class="text-lg text-gray-600 leading-relaxed text-justify animate-fade-in animate-delay-700">
                        Esta plantilla ha sido diseñada para facilitar la documentación y presentación de información de manera estructurada y profesional. Forma parte de nuestra colección de herramientas que contribuyen al desarrollo de investigaciones y proyectos de ley que registran y evidencian los avances de nuestra labor institucional.
                    </p>
                </div>
                ...
                <div class="flex justify-center items-center max-w-4xl mx-auto animate-fade-in animate-delay-700">
                    <!-- Back Button -->
                    <a href="/plantillas" class="flex items-center text-gray-600 hover:text-gray-800 transition-colors duration-200">
