...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Gestión de Publicaciones - DICAPI</title>
    ...
    <body class="antialiased bg-gray-100 admin-page">
        <div class="flex h-screen">
            <!-- Sidebar -->
            <div class="hidden lg:block w-64 bg-dark-blue text-white">
                <!-- Header -->
                ...
                <nav class="mt-6">
                    ...
                    <a href="/admin/publicaciones" class="flex items-center px-6 py-3 text-white bg-blue-800 border-l-4 border-yellow-400">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/admin/plantillas" class="flex items-center px-6 py-3 text-blue-100 hover:text-white hover:bg-blue-800 transition-colors duration-200">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                <!-- Mobile Header -->
                <header class="lg:hidden bg-dark-blue text-white px-4 py-3">
                    <div class="flex items-center justify-between">
                        <h1 class="text-lg font-bold">DICAPI Admin</h1>
                ...
                <div id="mobile-sidebar" class="lg:hidden hidden fixed inset-0 z-50">
                    ...
                    <div class="fixed left-0 top-0 h-full w-64 bg-dark-blue text-white transform transition-transform duration-300">
                        <!-- Mobile Logo -->
                        <div class="p-6 border-b border-blue-800">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <img src="{{ asset('imagenes/dicapilogo.png') }}" alt="DICAPI Logo" class="w-10 h-10 mr-3">
                                    <h1 class="text-xl font-bold">Admin Panel</h1>
                                </div>
                ...
                <!-- Desktop Header -->
                <header class="hidden lg:block bg-light-blue shadow-sm border-b border-gray-200">
                    <div class="flex items-center justify-between px-6 py-4">
                        <h2 class="main-title">Gestión de Publicaciones</h2>
                        <button onclick="toggleForm()" class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 hover:shadow-lg hover:scale-105 transition-all duration-200 flex items-center cursor-pointer font-medium">
                ...
                <div class="lg:hidden bg-white border-b border-gray-200 px-4 py-3">
                    <button onclick="toggleForm()" class="w-full bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 hover:shadow-lg transition-all duration-200 flex items-center justify-center cursor-pointer font-medium">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                        </svg>
                        Agregar Publicación
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
                    <div class="container mx-auto px-6 py-8">
                        ...
                        <div id="addForm" class="bg-white rounded-lg shadow-sm p-6 mb-8 {{ request('showForm') ? '' : 'hidden' }}">
                            <h3 class="text-lg font-semibold text-gray-900 mb-6">Agregar Nueva Publicación</h3>
                            
                            <form class="space-y-6" method="POST" action="{{ route('admin.publicaciones.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div>
                                    ...
                                    <div id="imageUpload" class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors duration-200">
                                        ...
                                        <label for="image" class="cursor-pointer">
                                            <span class="text-blue-600 hover:text-blue-700 font-medium">Seleccionar archivo</span>
                                    ...
                                    <div id="imagePreview" class="hidden mt-4">
                                        <div class="flex items-center space-x-4">
                                            <img id="previewImg" src="" alt="Vista previa" class="w-20 h-20 object-cover rounded border">
                                            <div>
                                ...
                                <div>
                                    ...
                                    <div id="pdfUpload" class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors duration-200">
                                        <svg class="w-12 h-12 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                        </svg>
                                        <input 
                                        ...
                                        <label for="pdf" class="cursor-pointer">
                                            <span class="text-blue-600 hover:text-blue-700 font-medium">Seleccionar PDF</span>
                                            <span class="text-gray-500"> o arrastrar aquí</span>
                                        </label>
                                    ...
                                    <div id="pdfPreview" class="hidden mt-4">
                                        <div class="flex items-center space-x-4">
                                            <div class="w-12 h-16 bg-red-100 rounded border flex items-center justify-center">
                                ...
                                <div class="flex justify-end space-x-4">
                                    ...
                                    <button 
                                        type="submit" 
                                        class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 hover:shadow-lg hover:scale-105 transition-all duration-200 cursor-pointer font-medium"
                                    >
                                        Guardar Publicación
                                    </button>
                                </div>
                        ...
                        <div id="editForm" class="bg-white rounded-lg shadow-sm p-6 mb-8 hidden">
                            <h3 class="text-lg font-semibold text-gray-900 mb-6">Editar Publicación</h3>
                            ...
                            <form class="space-y-6" method="POST" id="editFormElement" enctype="multipart/form-data">
                                ...
                                <!-- Resumen Field -->
                                <div>
                                    <label for="editResumen" class="block text-sm font-medium text-gray-700 mb-2">
                                        Resumen
                                    </label>
                                    <textarea 
                                        id="editResumen" 
                                ...
                                <div>
                                    ...
                                    <div id="editImageUpload" class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors duration-200 relative">
                                        <button type="button" onclick="closeEditImageUpload()" class="absolute top-2 right-2 text-gray-400 hover:text-gray-600 transition-colors duration-200 p-1 rounded-full hover:bg-gray-100">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                            </svg>
                                        </button>
                                    ...
                                    <div id="editImagePreview" class="hidden mt-4">
                                        <div class="flex items-center space-x-4">
                                            <img id="editPreviewImg" src="" alt="Vista previa" class="w-20 h-20 object-cover rounded border">
                                            <div>
                                                <p id="editFileName" class="text-sm font-medium text-gray-700"></p>
                                                <p id="editFileSize" class="text-xs text-gray-500"></p>
                                            </div>
                                            <button type="button" onclick="removeEditImage()" class="text-red-600 hover:text-red-800">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                                </svg>
                                            </button>
                                    ...
                                    <div id="editCurrentImage" class="hidden mt-4">
                                        <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                            <div class="flex items-center justify-between mb-3">
                                                <h4 class="text-sm font-medium text-gray-700">Imagen actual</h4>
                                                <div class="flex space-x-2">
                                                    <button type="button" onclick="showEditImageUpload()" class="text-blue-600 hover:text-blue-800 hover:bg-blue-50 px-2 py-1 rounded-md transition-all duration-200 text-sm font-medium cursor-pointer">
                                                        Cambiar
                                                    </button>
                                                    <button type="button" onclick="removeCurrentImage()" class="file-delete-button text-red-600 hover:text-red-800 hover:bg-red-50 px-2 py-1 rounded-md transition-all duration-200 text-sm font-medium cursor-pointer">
                                                        Eliminar
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="flex items-center space-x-4">
                                                <div class="w-24 h-24 bg-white rounded-lg border border-gray-200 overflow-hidden flex items-center justify-center">
                                                    <img id="editCurrentImageSrc" src="" alt="Imagen actual" class="w-full h-full object-cover">
                                                </div>
                                                <div class="flex-1">
                                                    <p class="text-xs text-gray-500">Imagen de vista previa actual</p>
                                ...
                                <div>
                                    ...
                                    <div id="editPdfUpload" class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors duration-200 relative">
                                    ...
                                    <!-- Current PDF Display -->
                                    <div id="editCurrentPdf" class="hidden mt-4">
                                        <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                            <div class="flex items-center justify-between mb-3">
                                                <h4 class="text-sm font-medium text-gray-700">Documento PDF actual</h4>
                                                <div class="flex space-x-2">
                                                    <button type="button" onclick="showEditPdfUpload()" class="text-blue-600 hover:text-blue-800 hover:bg-blue-50 px-2 py-1 rounded-md transition-all duration-200 text-sm font-medium cursor-pointer">
                                                        Cambiar
                                                    </button>
                                                    <button type="button" onclick="removeCurrentPdf()" class="file-delete-button text-red-600 hover:text-red-800 hover:bg-red-50 px-2 py-1 rounded-md transition-all duration-200 text-sm font-medium cursor-pointer">
                                                        Eliminar
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="flex items-center space-x-4">
                                                ...
                                                <div class="flex-1">
                                                    <p class="text-sm font-medium text-gray-700" id="editCurrentPdfName"></p>
                        ...
                        <div class="bg-white rounded-lg shadow-sm">
                            <div class="px-6 py-4 border-b border-gray-200">
                                <h3 class="text-lg font-semibold text-gray-900">Publicaciones Existentes</h3>
                            </div>
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-mono text-gray-900">{{ $publicacion->codigo }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $publicacion->fecha }}</td>
                                            <td class="px-6 py-4 text-sm text-gray-900">{{ $publicacion->titulo }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if($publicacion->imagen)
                                                <div class="w-16 h-12 bg-gray-200 rounded flex items-center justify-center">
                                                    <img src="{{ asset('storage/publicaciones/' . $publicacion->imagen) }}" alt="Imagen" class="w-full h-full object-cover rounded">
                                                </div>
                                                @else
                                                <div class="w-16 h-12 bg-gray-200 rounded flex items-center justify-center">
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center">
                                                        ...
                                                        <span class="text-sm text-gray-600 truncate max-w-xs">{{ $publicacion->pdf }}</span>
                                                    </div>
                                                    <a href="{{ asset('storage/publicaciones/' . $publicacion->pdf) }}" download="{{ $publicacion->pdf }}" class="text-blue-600 hover:text-blue-800 hover:bg-blue-50 p-2 rounded-md transition-all duration-200 cursor-pointer flex items-center justify-center">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-3">
                                                    <button onclick="editPublicacion({{ $publicacion->id }}, '{{ addslashes($publicacion->titulo) }}', '{{ $publicacion->codigo }}', '{{ addslashes($publicacion->resumen ?? '') }}', '{{ addslashes($publicacion->imagen ?? '') }}', '{{ addslashes($publicacion->pdf ?? '') }}')" class="px-3 py-1 text-blue-600 hover:text-blue-900 hover:bg-blue-50 rounded-md transition-all duration-200 cursor-pointer font-medium">Editar</button>
                                                    <button onclick="showDeleteConfirmation({{ $publicacion->id }}, '{{ addslashes($publicacion->titulo) }}')" class="px-3 py-1 text-red-600 hover:text-red-900 hover:bg-red-50 rounded-md transition-all duration-200 cursor-pointer font-medium">Eliminar</button>
                                                </div>
                                            </td>
                                        </tr>
                                        @empty
        ...
        <script>
            ...
            // Edit functions
            function editPublicacion(id, titulo, codigo, resumen, imagen, pdf) {
                ...
                document.getElementById('editFormElement').action = `/admin/publicaciones/${id}`;
                
                // Mostrar imagen actual si existe
                if (imagen && imagen !== '') {
                    console.log('Imagen actual:', imagen);
                    const imageSrc = `/storage/publicaciones/${imagen}`;
                    console.log('URL de imagen:', imageSrc);
                    document.getElementById('editCurrentImageSrc').src = imageSrc;
                    document.getElementById('editCurrentImage').classList.remove('hidden');
                    document.getElementById('editImageUpload').classList.add('hidden');
                } else {
                    document.getElementById('editCurrentImage').classList.add('hidden');
                    document.getElementById('editImageUpload').classList.remove('hidden');
                }
                
                // Mostrar PDF actual si existe
                if (pdf && pdf !== '') {
                    document.getElementById('editCurrentPdfName').textContent = pdf;
                    document.getElementById('editCurrentPdf').classList.remove('hidden');
                    document.getElementById('editPdfUpload').classList.add('hidden');
                } else {
                    document.getElementById('editCurrentPdf').classList.add('hidden');
            ...
            function removeCurrentPdf() {
                showDeleteFileConfirmation('pdf', 'PDF actual');
            }
                ...
                confirmButton.onclick = function() {
                    if (fileType === 'imagen') {
                        ...
                        if (!removeImageField) {
                            ...
                            document.getElementById('editFormElement').appendChild(removeImageField);
                        }
                        removeImageField.value = '1';
                    } else if (fileType === 'pdf') {
                        document.getElementById('editCurrentPdf').classList.add('hidden');
                        document.getElementById('editPdfUpload').classList.remove('hidden');
                        // Agregar un campo hidden para indicar que se debe eliminar el PDF
                        let removePdfField = document.getElementById('removePdf');
                        if (!removePdfField) {
                            removePdfField = document.createElement('input');
                            removePdfField.type = 'hidden';
                            removePdfField.name = 'remove_pdf';
                            removePdfField.id = 'removePdf';
                            document.getElementById('editFormElement').appendChild(removePdfField);
                        }
                        removePdfField.value = '1';
                    }
                    closeDeleteModal();
                };
            ...
            function showDeleteConfirmation(publicacionId, publicacionTitle) {
                const modal = document.getElementById('deleteModal');
                const modalTitle = document.getElementById('deleteModalTitle');
                const modalMessage = document.getElementById('deleteModalMessage');
                const confirmButton = document.getElementById('deleteConfirmButton');
                
                modalTitle.textContent = 'Eliminar Publicación';
                modalMessage.textContent = `¿Estás seguro de que quieres eliminar la publicación "${publicacionTitle}"? Esta acción no se puede deshacer.`;
                
                confirmButton.onclick = function() {
                    // Crear y enviar el formulario de eliminación
                    const form = document.createElement('form');
                    form.method = 'POST';
                    form.action = `/admin/publicaciones/${publicacionId}`;
            ...
            <div id="deleteModalContent" class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 transform transition-all border border-gray-200 backdrop-blur-sm">
                <div class="flex items-center justify-between p-6 border-b border-gray-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <h3 id="deleteModalTitle" class="text-lg font-semibold text-gray-900">Eliminar Publicación</h3>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    <p id="deleteModalMessage" class="text-gray-600 mb-6 leading-relaxed">¿Estás seguro de que quieres eliminar esta publicación? Esta acción no se puede deshacer.</p>
